...
# need genomic data . A sample of 22k random SNPs from the Arabidopsis 1001G Project is available as example for Arabidopsis traits
...
# for models with multiple causative markers, it is recommended to have them ordered by the amount of variance explained (ve)
...
# to simulate distinct markers, the script can be modified manually.
