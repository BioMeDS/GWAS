...
sim_Y_skewed<-function(n=100,acc=A,sp_acc=0,no_acc=200,fix_acc=TRUE,SNPs=X,no_snps=1,ve=.1,mac=5,h2=0.7,seed=42,bk=1000,skew=0,kurt=3) {
  stopifnot(no_snps>0)
...
#betas<-rpearson(bk,moments=c(mean=0,variance=0.01,skewness=skew,kurtosis=kurt))
first<- back %*% betas
